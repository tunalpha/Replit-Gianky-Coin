...
// Redot Pay referral URL
const REDOTPAY_URL = 'https://url.hk/i/en/srwfx';
...
const RedotPayPage = () => {
  ...
  return (
    ...
    >
      ...
      <iframe
        src={REDOTPAY_URL}
        title="Redot Pay - Crypto Card"
        className="w-full h-full border-0"
        allow="clipboard-write"
        allowFullScreen
        data-testid="redotpay-iframe"
      />
    </div>
  );
};

export default RedotPayPage;

...
const socials = [
  {
    name: 'YouTube',
    url: 'https://www.youtube.com/@GKYWEB3',
    icon: (
  ...
  {
    name: 'TikTok',
    url: 'https://www.tiktok.com/@giankyi73?_r=1&_d=e3cd8l1f492j8f&sec_uid=MS4wLjABAAAANbA2kqcS7SzWm1IITMWwW7by8dwtRM32QRFwq7penRnPULmt0eRZ-L9fjX5DcAte&share_author_id=7585313088078545942&sharer_language=it&source=h5_m&u_code=f12mk02d7g8kb7&timestamp=1788382158&user_id=7585313088078545942&sec_user_id=MS4wLjABAAAANbA2kqcS7SzWm1IITMWwW7by8dwtRM32QRFwq7penRnPULmt0eRZ-L9fjX5DcAte&item_author_type=1&utm_source=copy&utm_campaign=client_share&utm_medium=android&share_iid=7679210417470588694&share_link_id=5c678a3a-c9f8-447e-b24d-904c0d396e46&share_app_id=1233&ugbiz_name=ACCOUNT&ug_btm=b8727%2Cb7360&social_share_type=5&enable_checksum=1',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 mb-12">
          ...
          >
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {socials.map((social) => social.disabled ? (
                <motion.div
                  key={social.name}
                  aria-disabled="true"
                  className="w-10 h-10 rounded-xl glass flex items-center justify-center text-slate-600 opacity-60 cursor-not-allowed"
                  title={`${social.name} non disponibile`}
